...
class TestLayerUtils(unittest.TestCase):
    def test_padded_mean(self):
        ...
        actual = utils.padded_mean(test_matrix)
    ...
    def test_normalize_adjacency_matrix(self):
        ...
        actual_standard = utils.normalize_adjacency_matrix(mat, False, False)
        self.assertTrue(
        ...
        actual_symmetric = utils.normalize_adjacency_matrix(mat, True, False)
        self.assertTrue(
